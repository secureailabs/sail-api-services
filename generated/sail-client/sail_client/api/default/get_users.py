...
) -> Optional[Union[GetMultipleUsersOut, HTTPExceptionObj, ValidationError]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetMultipleUsersOut.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[GetMultipleUsersOut, HTTPExceptionObj, ValidationError]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[GetMultipleUsersOut, HTTPExceptionObj, ValidationError]
    """
